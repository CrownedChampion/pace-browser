...
// v1.9: themes can also skin the chrome bars, tabs, and address bar (bar/UI keys below).
const DESIGN_KEYS = ['accent', 'accent2', 'bg0', 'bg1', 'glass', 'glass2', 'glassHi',
  ...
  'barBg', 'toolbarBg', 'tabBg', 'tabHoverBg', 'tabActiveBg', 'tabLine', 'tabActiveLine',
  'tabText', 'tabActiveText', 'addrBg', 'addrLine', 'addrText'];
...
const BUILTINS = [
  ...
  },
  {
    ...
    design: { barBg:'rgba(10,14,26,.55)', tabActiveBg:'rgba(34,211,238,.14)', tabActiveLine:'#22d3ee', tabHoverBg:'rgba(34,211,238,.08)', addrBg:'rgba(12,18,32,.6)', addrLine:'rgba(34,211,238,.28)',
  ...
  },
  {
    ...
    design: { barBg:'rgba(16,10,30,.55)', tabActiveBg:'rgba(139,92,246,.16)', tabActiveLine:'#8b5cf6', tabHoverBg:'rgba(139,92,246,.09)', addrBg:'rgba(18,12,34,.6)', addrLine:'rgba(139,92,246,.3)',
  ...
  },
  {
    ...
    design: { barBg:'rgba(8,20,16,.5)', tabActiveBg:'rgba(52,211,153,.13)', tabActiveLine:'#34d399', tabHoverBg:'rgba(52,211,153,.08)', addrBg:'rgba(10,22,18,.55)', addrLine:'rgba(52,211,153,.28)',
